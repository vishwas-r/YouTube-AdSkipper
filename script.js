...
k&&a!==b&&(c&&b&&(c.disconnect(),e(b)),c||(c=new MutationdomTreeObserver(function(){null!==b.offsetParent&&(e(b),b=void 0,c.disconnect())})),b=a,c.observe(k,{attributes:!0}))}function h(){n(classList).forEach(function(a){null===a.offsetParent?p(a):e(a)})}function m(){if(!("MutationdomTreeObserver"in window))return!1;var a=function(b){return b&&b[0]}(document.getElementsByTagName("ytd-player"));if(!a)return!1;(new MutationdomTreeObserver(function(){h()})).observe(a,{childList:!0,subtree:!0});clearTimeout(f);
return!0}var f;try{var l=window.self!==window.top}catch(a){l=!0}l||g()})();